      ...
      <div className="lg:grid lg:grid-cols-[1fr_300px] lg:gap-10">
        <div>
          ...
          <div className="prose-content space-y-6 text-gray-700 leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-gray-900 pt-2">Who Qualifies?</h2>
            <p>
              The{' '}
            ...
            <h2 className="text-xl font-bold text-gray-900 pt-2">Common Injection Formulations</h2>
            ...
            <h2 className="text-xl font-bold text-gray-900 pt-2">TRT Cost</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-gray-900 pt-2">Risks to Discuss With Your Provider</h2>
            <ul className="list-disc pl-5 space-y-1 text-gray-600">
        ...
        <aside className="mt-8 lg:mt-0 space-y-6">
          ...
          <div className="bg-red-50 border border-red-100 rounded-[10px] p-5">
